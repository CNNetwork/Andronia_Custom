...
public class ModFluids {
    public static final ResourceLocation TRASH_STILL_RL = new ResourceLocation(AndroCustom.MOD_ID,
            "block/trash_still");

    public static final ResourceLocation TRASH_FLOWING_RL = new ResourceLocation(AndroCustom.MOD_ID,
            "block/trash_flowing");
